...
symb = dict([
            ('groene boei', '011'),
            ('groene boei met topteken', '012'),
            ('groene lichtboei', '013'),
            ('groene lichtopstand', '015'),
            ('groene boei met radarscherm', '012'),
            ('landbaken groen', '001'),
            ('landbaken rood', '005'),
            ('rode boei', '019'),
            ('rode boei met radarscherm', '020'),
            ('rode lichtboei', '021'),
            ('rode lichtopstand', '023'),
            ('aanvullende markering groen-wit', '097'),
            ('aanvullende markering rood-wit', '105'),
